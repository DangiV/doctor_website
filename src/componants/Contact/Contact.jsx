...
function Contact() {
  ...
  return (
    <>
      <section className="py-md-16 py-4 ">
        <div className="text-center">

          <h1 className="text-4xl font-semibold text-gray-800 head">Book Appointment</h1>
          <p className="text-lg text-gray-600 mt-md-4 desctxt">
        ...
        <div className="flex items-center justify-center">
          <div className='p-md-8 p-2 text-center '>
            <p>Returning Patient?</p>
            <div className="space-x-4 mt-6 ">
              <button
                onClick={() => setShowForm(1)} // Show form 1
                className="relative px-8 py-md-2 py-1 rounded-md bg-white isolation-auto z-10 border-2 border-lime-500
        ...
        {showForm === 1 && (
          <div className="max-w-4xl mx-md-auto p-md-8 p-3 m-3 bg-white rounded-lg shadow-lg">
            <form onSubmit={handleSubmitForm1} className='form1'>
              ...
              <div className="text-center mt-md-8 mt-3">
                <button
                  type="submit"
                  className="bg-red-600 text-white font-semibold py-md-3 py-1 px-md-6 px-3 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                >
                  Submit
                </button>
              </div>
          ...
          <div className="max-w-4xl mx-md-auto p-md-8 p-3 m-3 bg-white rounded-lg shadow-lg">
            <form onSubmit={handleSubmitForm2} className='form2'>
              ...
              <div className='text-center'>
                ...
                <button
                  type="submit"
                  className="bg-red-600 text-white mx-auto font-semibold py-md-3 py-1 px-md-6 px-3  rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                >
                  Submit
                </button>
              </div>
